"""
Module: agilab_models_CNN
Stage: Library
Author: AngusHsu
Date: 2026-07-15
Description: 打包CNN類別於agilab.models
"""
...
class CNN(torch.nn.Module):
    ...
    def prepare_images(self, xt):  # 對圖片進行預處理，以符合PyTorch的格式需求
...
if __name__ == "__main__":
    ...
    for i in range(epochs):
        ...
        xt = model.prepare_images(xt).unsqueeze(dim=1)  # 加入通道軸
